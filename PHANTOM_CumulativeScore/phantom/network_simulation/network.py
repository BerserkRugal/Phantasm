...
class Network:
    ...
    def __getitem__(self, miner_name: "Miner.Name") -> "Miner":
        if miner_name not in self._network_graph:
            return None
        return self._network_graph.nodes[miner_name][self._MINER_KEY]
    ...
    def get_random_miner(self, according_to_hash_rate: bool = True) -> "Miner":
        ...
        for miner_name in self:
            ...
            miner_hash_rate = self._network_graph.nodes[miner_name][self._HASH_RATE_KEY]
    ...
    def add_miner(self,
        ...
        self._network_graph.nodes[miner_name][Network._MINER_KEY] = miner
        self._network_graph.nodes[miner_name][Network._HASH_RATE_KEY] = hash_rate
    ...
    def draw_network(self, with_labels: bool = False):
        ...
        pos = nx.shell_layout(self._network_graph) # concentric circles layout
    ...
    def __str__(self):
        ...
        miners_str = "Active miners in the network:\n" + \
                     '\n'.join([
                         str(self[miner_name]) +
                         ", hash rate: " + str(self._network_graph.nodes[miner_name][self._HASH_RATE_KEY]) + ", "
    ...
    def get_next_global_id(self):
        self._inc_global_id += 1
        return self._inc_global_id