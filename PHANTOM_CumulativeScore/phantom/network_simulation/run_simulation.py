...
from phantom.network_simulation.miner import Miner
...
if __name__ == '__main__':
    ...
    print("cumulative ---> k=" + str(k) + ", bpm=" + str(blocks_per_minute) + ", depth=" + str(confirmation_depth))
