...
if __name__ == '__main1__':
    ...
    print("total blocks: " + str(len(sim._network["M6"]._dag)) + ", coloring ratio: " +
          ...
          ", colored blocks per minute: " + str(len(sim._network["M6"]._dag._get_coloring())/sim._env.now*60))
...
if __name__ == '__main__':
    ...
    print("Original ---> k=" + str(k) + ", bpm=" + str(blocks_per_minute) + ", depth=" + str(confirmation_depth))
